...
# phantomjs ./run-qunit.js http://localhost/jquery/test/index.html?module=deferred FAILS
...
# phantomjs ./run-qunit.js http://localhost/jquery/test/index.html?module=basic FAILS
